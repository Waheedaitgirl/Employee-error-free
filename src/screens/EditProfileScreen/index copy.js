...
import { useGetCandidatesQuery } from "../../api/services/taskApi";
import {
  country_data,
  state_data,
} from '../../data/data';
...
const GeneralProfileScreen = ({navigation}) => {
  ...
  const { data, error, isLoading, isSuccess } = useGetCandidatesQuery("1336");
  console.log( data,"data", error,"error", isLoading,"isLoading", isSuccess,"isSuccess");
            ...
            <View
              style={{
                ...
                <View style={{position:"absolute", right:wp(5)}}>
                  <Gravatar 
                      emailAddress='engr.aftabufaq@gmail.com'  
                  />
                </View>
              
                  
                  <Text style={styles.profileInfoText}>Hasir Numan</Text>
                  <Text style={styles.profileInfoText}>
                    engr.aftabufaq@gmail.com
                  </Text>
                  <Text style={styles.profileInfoText}>
                   +923168890612
                  </Text>
